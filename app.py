...
async def home():
    return {
        ...
        "Project": "FF Token Revoke Ultra Fast API",
        "Message": "Welcome to FF Token Revoke API",
        "API_Usage_Guide": {
            "API_Format": {
                "Revoke_Token": "/logout?access_token=[Your_Access_Token]"
            },
            "Examples": {
                "By_Token": "/logout?access_token=YOUR_ACCESS_TOKEN_HERE"
            }
        }
    }
    ...
    async with httpx.AsyncClient(verify=False) as client:
        ...
        if error:
            return {
                ...
                "TelegramBot": "https://t.me/RiduanFFBot",
                "TelegramChannel": "https://t.me/RiduanOfficialBD",
                "message": "FAILED already logout or token not work"
            }
